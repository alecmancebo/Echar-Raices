...
const StartMenu = () => {
    ...
    return (
        <div className="game-container start-menu">
            <img className="start-menu__bg" src="/UI/fondo.png" alt="Fondo del bosque" />
            <div className="start-menu__content">
                <img className="start-menu__logo" src="/UI/titulo.png" alt="Echar Raíces" />

                <div className="start-menu__links">
                    <button className="start-menu__link" onClick={handleNuevaPartida}>
                        <img className="start-menu__arrow" src="/UI/flecha-der.png" alt="" />
                        NUEVA PARTIDA
                    </button>
